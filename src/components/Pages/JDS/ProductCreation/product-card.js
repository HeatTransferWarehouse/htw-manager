          ...
          {product.variants?.length > 0 && (
            <div className="flex border-stone-400 overflow-hidden border rounded-md flex-col">
              <div className="grid border-b bg-stone-100 border-stone-400 grid-cols-10">
                <p className="w-full col-span-4 border-r border-stone-400 p-3">
                  Variant
                </p>
                <p className="w-full col-span-4 border-r border-stone-400 p-3">
                  SKU
              ...
              {product.variants?.map((variant, variantIndex) => {
                const createdName = variant.option_values
                ...
                return (
                  <div
                    ...
                    <p className="w-full col-span-4 border-r border-stone-400 ">
                      <SkuInput
                        value={variant.sku}
                        ...
                        onChange={(newSku) => {
                          ...
                          setMainProducts((prevProducts) => {
                            const updatedProducts = [...prevProducts];
                            updatedProducts[index].variants[variantIndex].sku =
                              newSku;
                            return updatedProducts;
                          });
                        }}
                    ...
                    <p className="w-full col-span-2 p-3">{variant.price}</p>
                  </div>
                );
              })}
            </div>
