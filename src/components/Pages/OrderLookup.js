            ...
            {products === false
              ...
              products.map((item, index) => [
                item.sku.slice(0, 5) === "BL_A3" ||
                  ...
                  item.sku.slice(0, 10) === "INKSOFT-SB" ||
                  item.sku.slice(0, 10) === "INKSOFT-SO" ||
                  item.sku.slice(0, 10) === "INKSOFT-BL" ||
                  item.sku.slice(0, 10) === "INKSOFT-PR" ||
                  item.sku.slice(0, 10) === "INKSOFT-HE" ||
                  item.sku.slice(0, 10) === "INKSOFT-HW" ||
                  ...
                  <>
                    <tr>
                      ...
                      >
                        ...
                        <i>
                          {" "}
                          {item.sku.slice(0, 13) === "INKSOFT-BL_A3"
                            ? ("BL_A3")
                            : item.sku === "INKSOFT-SUB-BLOCKER-8"
                              ? ("BL_A3")
                              : item.sku.slice(0, 15) === "INKSOFT-BL_A4-1"
                                ? ('BL_A4:SubBlock-A4 16.5" 5.85"')
                                : item.sku === "INKSOFT-SUB-BLOCKER-6"
                                  ? ('BL_A4 16.5')
                                  : item.sku.slice(0, 15) === "INKSOFT-BL_A4-8"
                                    ? ('BL_A4:SubBlock-A4 8.3" 11.7"')
                                    : item.sku === "INKSOFT-SUB-BLOCKER-5"
                                      ? ('BL_A4 8.3')
                                      : item.sku.slice(0, 15) === "INKSOFT-BL_A5-1"
                                        ? ('BL_A5:SubBlock-A5 11.7" 4.25"')
                                        : item.sku === "INKSOFT-SUB-BLOCKER-4"
                                          ? ('BL_A5 11.7')
                                          : item.sku.slice(0, 15) === "INKSOFT-BL_A5-5"
                                            ? ('BL_A5:SubBlock-A5 5.8" 8.3"')
                                            : item.sku === "INKSOFT-SUB-BLOCKER-3"
                                              ? ('BL_A5 5.8')
                                              : item.sku.slice(0, 13) === "INKSOFT-BL_LC"
                                                ? ("BL_LC")
                                                : item.sku === "INKSOFT-SUB-BLOCKER-2"
                                                  ? ("BL_LC")
                                                  : item.sku === "INKSOFT-SUB-BLOCKER-9"
                                                    ? ("BL_XS")
                                                    : item.sku.slice(0, 13) === "INKSOFT-BL_SM"
                                                      ? ("BL_SM")
                                                      : item.sku === "INKSOFT-SUB-BLOCKER-7"
                                                        ? ("BL_SQ")
                                                        : item.sku === "INKSOFT-SUB-BLOCKER-1"
                                                          ? ("BL_SM")
                                                          : item.sku.slice(0, 16) === "INKSOFT-HW_CAP_L"
                                                            ? ("HW_CAP_L")
                                                            : item.sku === "INKSOFT-HEAD-2"
                                                              ? ("HW_CAP_L")
                                                              : item.sku.slice(0, 16) === "INKSOFT-HW_CAP_S"
                                                                ? ("HW_CAP_S")
                                                                : item.sku === "INKSOFT-HEAD-1"
                                                                  ? ("HW_CAP_S")
                                                                  : item.sku.slice(0, 19) === "INKSOFT-PR_BAG_A4-1"
                                                                    ? ("PR_BAG_A4:BAG-A4 16.5")
                                                                    : item.sku === "INKSOFT-PROMO-5"
                                                                      ? ("PR_BAG_A4:BAG-A4 16.5")
                                                                      : item.sku.slice(0, 19) === "INKSOFT-PR_BAG_A4-8"
                                                                        ? ("PR_BAG_A4:BAG-A4 8.3")
                                                                        : item.sku === "INKSOFT-PROMO-4"
                                                                          ? ("PR_BAG_A4:BAG-A4 8.3")
                                                                          : item.sku === "INKSOFT-PROMO-6"
                                                                            ? ("PR_BAG_A3:Bag-A3 11.7")
                                                                            : item.sku.slice(0, 19) === "INKSOFT-PR_BAG_A5-1"
                                                                              ? ("PR_BAG_A5:Bag-A5 11.7")
                                                                              : item.sku === "INKSOFT-PROMO-3"
                                                                                ? ("PR_BAG_A5:Bag-A5 11.7")
                                                                                : item.sku.slice(0, 19) === "INKSOFT-PR_BAG_A5-5"
                                                                                  ? ("PR_BAG_A5:Bag-A5 5.8")
                                                                                  : item.sku === "INKSOFT-PROMO-2"
                                                                                    ? ("PR_BAG_A5:Bag-A5 5.8")
                                                                                    : item.sku.slice(0, 19) === "INKSOFT-PR_BAG_A6-4"
                                                                                      ? ("PR_BAG_A6:Bag-A6 4.1")
                                                                                      : item.sku === "INKSOFT-PROMO-1"
                                                                                        ? ("PR_BAG_A6:Bag-A6 4.1")
                                                                                        : item.sku.slice(0, 16) === "INKSOFT-PR_UM_A3"
                                                                                          ? ("PR_UM_A3")
                                                                                          : item.sku.slice(0, 19) === "INKSOFT-PR_UM_A4-11"
                                                                                            ? ("PR_UM_A4 11.7")
                                                                                            : item.sku.slice(0, 19) === "INKSOFT-PR_UM_A4-16"
                                                                                              ? ("PR_UM_A4 16.5")
                                                                                              : item.sku.slice(0, 19) === "INKSOFT-PR_UM_A5-11"
                                                                                                ? ("PR_UM_A5 11.7")
                                                                                                : item.sku.slice(0, 18) === "INKSOFT-PR_UM_A5-5"
                                                                                                  ? ("PR_UM_A5 5.8")
                                                                                                  : item.sku.slice(0, 13) === "INKSOFT-SB_A3"
                                                                                                    ? ("SB_A3")
                                                                                                    : item.sku === "INKSOFT-SOFT-SHELL-8"
                                                                                                      ? ("SB_A3")
                                                                                                      : item.sku.slice(0, 15) === "INKSOFT-SB_A4-1"
                                                                                                        ? ("SB_A4 16.5")
                                                                                                        : item.sku === "INKSOFT-SOFT-SHELL-6"
                                                                                                          ? ("SB_A4 16.5")
                                                                                                          : item.sku.slice(0, 15) === "INKSOFT-SB_A4-8"
                                                                                                            ? ("SB_A4 8.3")
                                                                                                            : item.sku === "INKSOFT-SOFT-SHELL-5"
                                                                                                              ? ("SB_A4 8.3")
                                                                                                              : item.sku.slice(0, 16) === "INKSOFT-SB_A5-11"
                                                                                                                ? ("SB_A5 11.7")
                                                                                                                : item.sku === "INKSOFT-SOFT-SHELL-4"
                                                                                                                  ? ("SB_A5 11.7")
                                                                                                                  : item.sku.slice(0, 15) === "INKSOFT-SB_A5-5"
                                                                                                                    ? ("SB_A5 5.8")
                                                                                                                    : item.sku === "INKSOFT-SOFT-SHELL-3"
                                                                                                                      ? ("SB_A5 5.8")
                                                                                                                      : item.sku.slice(0, 13) === "INKSOFT-SB_LC"
                                                                                                                        ? ("SB_LC")
                                                                                                                        : item.sku === "INKSOFT-SOFT-SHELL-2"
                                                                                                                          ? ("SB_LC")
                                                                                                                          : item.sku.slice(0, 13) === "INKSOFT-SB_SM"
                                                                                                                            ? ("SB_SM")
                                                                                                                            : item.sku === "INKSOFT-SOFT-SHELL-1"
                                                                                                                              ...
                                                                                                                              : item.sku === "INKSOFT-SOFT-SHELL-9"
                                                                                                                                ...
                                                                                                                                : item.sku === "INKSOFT-SOFT-SHELL-7"
                                                                                                                                  ? ("SB_SQ")
                                                                                                                                  : item.sku.slice(0, 13) === "INKSOFT-WE_A3"
                                                                                                                                    ? ("WE_A3")
                                                                                                                                    : item.sku === "INKSOFT-WEARABLES-9"
                                                                                                                                      ? ("WE_A3")
                                                                                                                                      : item.sku.slice(0, 16) === "INKSOFT-WE_A4-16"
                                                                                                                                        ? ("WE_A4 16.5")
                                                                                                                                        : item.sku === "INKSOFT-WEARABLES-7"
                                                                                                                                          ? ("WE_A4 16.5")
                                                                                                                                          : item.sku.slice(0, 15) === "INKSOFT-WE_A4-8"
                                                                                                                                            ? ("WE_A4 8.3")
                                                                                                                                            : item.sku === "INKSOFT-WEARABLES-6"
                                                                                                                                              ? ("WE_A4 8.3")
                                                                                                                                              : item.sku.slice(0, 16) === "INKSOFT-WE_A5-11"
                                                                                                                                                ? ("WE_A5 11.7")
                                                                                                                                                : item.sku === "INKSOFT-WEARABLES-5"
                                                                                                                                                  ? ("WE_A5 11.7")
                                                                                                                                                  : item.sku.slice(0, 15) === "INKSOFT-WE_A5-5"
                                                                                                                                                    ? ("WE_A5 5.8")
                                                                                                                                                    : item.sku === "INKSOFT-WEARABLES-4"
                                                                                                                                                      ? ("WE_A5 5.8")
                                                                                                                                                      : item.sku.slice(0, 13) === "INKSOFT-WE_LC"
                                                                                                                                                        ? ("WE_LC")
                                                                                                                                                        : item.sku === "INKSOFT-WEARABLES-3"
                                                                                                                                                          ? ("WE_LC")
                                                                                                                                                          : item.sku.slice(0, 13) === "INKSOFT-WE_SM"
                                                                                                                                                            ? ("WE_SM")
                                                                                                                                                            : item.sku === "INKSOFT-WEARABLES-2"
                                                                                                                                                              ? ("WE_SM")
                                                                                                                                                              : item.sku.slice(0, 13) === "INKSOFT-WE_SQ"
                                                                                                                                                                ? ("WE_SQ")
                                                                                                                                                                : item.sku === "INKSOFT-WEARABLES-8"
                                                                                                                                                                  ? ("WE_SQ")
                                                                                                                                                                  : item.sku.slice(0, 13) === "INKSOFT-WE_XS"
                                                                                                                                                                    ? ("WE_XS")
                                                                                                                                                                    : item.sku === "INKSOFT-WEARABLES-1"
                                                                                                                                                                      ? ("WE_XS")
                                                                                                                                                                      : item.sku.slice(0, 19) === "INKSOFT-WE_SUPAGANG"
                                                                                                                                                                        ? ("WE_SUPAGANG")
                                                                                                                                                                        : item.sku === "INKSOFT-WEARABLES-10"
                                                                                                                                                                          ? ("WE_SUPAGANG")
                                                                                                                                                                          : item.sku.slice(0, 19) === "INKSOFT-BL_SUPAGANG"
                                                                                                                                                                            ? ("BL_SUPAGANG")
                                                                                                                                                                            : item.sku === "INKSOFT-SUB-BLOCKER-10"
                                                                                                                                                                              ? ("BL_SUPAGANG")
                                                                                                                                                                              : item.sku.slice(0, 19) === "INKSOFT-SB_SUPAGANG"
                                                                                                                                                                                ? ("SB_SUPAGANG")
